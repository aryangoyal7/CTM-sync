...
def parse_args():
    ...
    p.add_argument("--log_dir", type=str, default="logs/finetune_sync_fir")
    ...
    # Model args (match tasks/image_classification/train.py defaults)
...
def main():
    ...
    # Load old checkpoint (same dims, so safe to load all keys non-strict)
    ...
    # Freeze everything, then unfreeze only FIR filter params
